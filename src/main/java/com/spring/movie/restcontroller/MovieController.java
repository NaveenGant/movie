...
public class MovieController {
  ...
  public ResponseEntity<MovieEntity> savemovieRow(MovieEntity movieEntity){
...
//  public ResponseEntity<List<GenereSubTotal>> getGenreMoviesWithSubtotals() {
//      List<GenereSubTotal> genreMovieSubtotals = service.getGenreMoviesWithSubtotals();
//      return ResponseEntity.status(HttpStatus.OK).body(genreMovieSubtotals);
//  }
}
